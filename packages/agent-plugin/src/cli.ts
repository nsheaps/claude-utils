...
Dependencies:
      ...
      Make sure <cli> is runnable, installing <mise-package> via \`mise use -g\` when this
      plugin's \`autoInstall\` setting is true. autoInstall defaults to false, and the caller
      never passes it.
